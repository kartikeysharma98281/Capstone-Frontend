  ...
  return (
    <header className="progress-bar-4">
      ...
      <div className="completed-frame">
        <div className="component-46-parent">
          <img
        ...
        <div className="skills-projects-bar">
          <div className="component-44-wrapper">
            <img
          ...
          <div className="component-36">
            <div className="rectangle-instance">
              <div className="nested-progress-bar">Skills and Projects</div>
            </div>
          </div>
        </div>
      </div>
