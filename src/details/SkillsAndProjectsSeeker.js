...
const SkillsAndProjectsseeker = () => {
  ...
  return (
    <div className="w-full h-[1189px] relative bg-fafafa overflow-y-auto tracking-[normal] text-left text-lgi-5 text-color font-font mq675:h-auto mq675:min-h-[1189]">
      ...
      <button
        className="cursor-pointer [border:none] py-[6.4px] px-14 bg-color absolute top-[1112px] left-[704px] rounded-[3.96px] flex flex-row items-start justify-start gap-[16px]"
        onClick={onSkillsAndProjectButtonClick}
      >
      ...
      <div
        className="absolute top-[1120px] left-[584px] text-base-3 text-e5d283 inline-block min-w-[59px] cursor-pointer"
      ...
      />
      <Education1 prop="1" />
      <Education1 prop="2" frameDivTop="466px" />
      <div className="absolute top-[774px] left-[calc(50%_-_673px)] w-[777px] flex flex-col items-end justify-start gap-[18px] max-w-full text-72xl-3 text-f709c">
        ...
        <footer className="w-[685px] flex flex-row items-start justify-end py-0 px-px box-border max-w-full text-left text-base-3 text-silver-100 font-font">
